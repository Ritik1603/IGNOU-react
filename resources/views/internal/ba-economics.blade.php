...
@section('page_h1', 'Economics, IGNOU Solved Assignments')
	...
	<div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm" style="background-image:url(images/background/bg3.jpg);">
		<div class="container">
			<div class="dz-bnr-inr-entry">
				<h1>Economics, IGNOU Solved Assignments</h1>
				<nav aria-label="breadcrumb" class="breadcrumb-row">
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{ route('page.show', ['page' => 'index']) }}"> Home</a></li>
						<li class="breadcrumb-item">BA -> Economics</li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div class="product-grid container-fluid mt-5 mb-5">
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">MEC-03/MEC-103</h3>
				<p class="product-subtitle">Quantitative Methods</p>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">MEC-05</h3>
				<p class="product-subtitle">Economics Analysis</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">MEC-07</h3>
				<p class="product-subtitle">Statistics for Economics</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">MEC-10</h3>
				<p class="product-subtitle">Macro Economics</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
