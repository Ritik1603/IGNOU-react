...
@section('page_h1', 'Sociology, IGNOU Solved Assignments')
  ...
  <div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm" style="background-image:url(images/background/bg3.jpg);">
    <div class="container">
      <div class="dz-bnr-inr-entry">
        <h1>Sociology, IGNOU Solved Assignments</h1>
        <nav aria-label="breadcrumb" class="breadcrumb-row">
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('page.show', ['page' => 'index']) }}"> Home</a></li>
            <li class="breadcrumb-item">BA -> Sociology</li>
          </ul>
        </nav>
      </div>
    </div>
  ...
  <div class="product-grid container-fluid mt-5 mb-5">
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 101 </h3>
        <p class="product-subtitle">Introduction to Sociology I</p>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 102</h3>
        <p class="product-subtitle">Sociology of India – I</p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 103</h3>
        <p class="product-subtitle">Introduction to Sociology - II </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 104</h3>
        <p class="product-subtitle">Sociology of India - II </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 111</h3>
        <p class="product-subtitle">Sociological Thinkers -I </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BSOC 113 </h3>
        <p class="product-subtitle">Sociological Thinkers -II </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
