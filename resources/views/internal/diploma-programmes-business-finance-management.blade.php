...
@section('page_h1', 'Business, Finance & Management Programmes')
...
<div class="container">
    <h3 class="page-title">Business, Finance & Management Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DEVMT%20(Diploma%20in%20Event%20Management)" class="course-card" data-search="9.4 devmt event management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Event Management</h3>
                <p class="course-code">DEVMT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DWED%20(Diploma%20in%20Women’s%20Empowerment%20and%20Development)" class="course-card" data-search="9.14 dwed women empowerment development">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Women’s Empowerment and Development</h3>
                <p class="course-code">DWED </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DBPOFA%20(Diploma%20in%20Business%20Process%20Outsourcing%20Finance%20and%20Accounting)" class="course-card" data-search="9.16 dbpofa bpo finance accounting">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Business Process Outsourcing Finance and Accounting</h3>
                <p class="course-code">DBPOFA</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DMOP%20(Diploma%20in%20Modern%20Office%20Practice)" class="course-card" data-search="9.17 dmop modern office practice">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Modern Office Practice</h3>
                <p class="course-code">DMOP </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DSCDM%20(Diploma%20in%20Smart%20City%20Development%20and%20Management)" class="course-card" data-search="9.27 dscdm smart city development management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Smart City Development and Management</h3>
                <p class="course-code">DSCDM </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
