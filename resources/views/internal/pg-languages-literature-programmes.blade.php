...
@section('page_h1', 'Languages & Literature Programmes')
...
<div class="container">
    <h3 class="page-title">Languages & Literature Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDT-Admission-2025']) }}" class="course-card" data-search="pgdt translation hindi">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Translation</h3>
                <p class="course-code">PGDT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDSHST-Admission-2025']) }}" class="course-card" data-search="pgdshst sindhi hindi translation">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Sindhi-Hindi-Sindhi Translation</h3>
                <p class="course-code">PGDSHST</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDGPS-Admission-2025']) }}" class="course-card" data-search="pgdgps gandhi peace studies">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Gandhi and Peace Studies</h3>
                <p class="course-code">PGDGPS</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-British-Literature']) }}" class="course-card" data-search="pgdblt british literature">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in British Literature</h3>
                <p class="course-code">PGDBLT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-The-Novel']) }}" class="course-card" data-search="pgdnov novel english">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in The Novel</h3>
                <p class="course-code">PGDNOV</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-American-Literature']) }}" class="course-card" data-search="pgdaml american literature">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in American Literature</h3>
                <p class="course-code">PGDAML</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="#" class="course-card" data-search="pgdnleg new literature english">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in New Literature in English</h3>
                <p class="course-code">PGDNLEG</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
