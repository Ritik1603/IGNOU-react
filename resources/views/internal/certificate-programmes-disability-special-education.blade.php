...
@section('page_h1', 'Disability & Special Education Programmes')
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .course-card {
        background: var(--card-bg); border-radius: var(--radius); padding: 28px 30px; position: relative; height: 170px;
...
<div class="container">
    <h3 class="page-title">Disability & Special Education Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CESEIVI%20(Certificate%20in%20Early%20Childhood%20Special%20Education%20Enabling%20Inclusion%20–%20Visual%20Impairment)" class="course-card" data-search="ceseivi visual impairment special education">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Certificate in Early Childhood Special Education Enabling Inclusion – Visual Impairment</h3>
                <p class="course-code">CESEIVI</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CESEIHI%20(Certificate%20in%20Early%20Childhood%20Special%20Education%20Enabling%20Inclusion%20–%20Hearing%20Impairment)" class="course-card" data-search="ceseihi hearing impairment special education">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Certificate in Early Childhood Special Education Enabling Inclusion – Hearing Impairment</h3>
                <p class="course-code">CESEIHI</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CESEIID%20(Certificate%20in%20Early%20Childhood%20Special%20Education%20Enabling%20Inclusion%20–%20Intellectual%20Disability)" class="course-card" data-search="ceseiid intellectual disability special education">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Certificate in Early Childhood Special Education Enabling Inclusion – Intellectual Disability</h3>
                <p class="course-code">CESEIID</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CIG%20(Certificate%20in%20Guidance)" class="course-card" data-search="cig guidance">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Certificate in Guidance</h3>
                <p class="course-code">CIG</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
