...
@section('page_h1', 'Creative Arts & Languages Programmes')
...
<div class="container">
    <h3 class="page-title">Creative Arts & Languages Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DCE%20(Diploma%20in%20Creative%20Writing%20in%20English)" class="course-card" data-search="9.6 dce creative writing english">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Creative Writing in English</h3>
                <p class="course-code">DCE </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DUL%20(Diploma%20in%20Urdu%20Language)" class="course-card" data-search="9.7 dul urdu language">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Urdu Language</h3>
                <p class="course-code">DUL </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DTG%20(Diploma%20in%20Teaching%20German%20as%20a%20Foreign%20Language)" class="course-card" data-search="9.22 dtg teaching german foreign language">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Teaching German as a Foreign Language</h3>
                <p class="course-code">DTG </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DNA%20(Diploma%20in%20Nursing%20Administration)" class="course-card" data-search="9.23 dna nursing administration">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Nursing Administration</h3>
                <p class="course-code">DNA </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DTH%20(Diploma%20in%20Theatre%20Arts)" class="course-card" data-search="9.25 dth theatre arts">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Theatre Arts</h3>
                <p class="course-code">DTH </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
