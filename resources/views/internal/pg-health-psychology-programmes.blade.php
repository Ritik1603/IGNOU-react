...
@section('page_h1', 'Health & Psychology Programmes')
...
<div class="container">
    <h3 class="page-title">Health & Psychology Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDMH-Admission-2025']) }}" class="course-card" data-search="pgdmh mental health">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Mental Health</h3>
                <p class="course-code">PGDMH</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDRPC-Admission-2025']) }}" class="course-card" data-search="pgdrpc rehabilitation psychology">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Rehabilitation Psychology</h3>
                <p class="course-code">PGDRPC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Geriatric-Medicine']) }}" class="course-card" data-search="pgdgm geriatric medicine">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Geriatric Medicine</h3>
                <p class="course-code">PGDGM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Maternal-and-Child-Health']) }}" class="course-card" data-search="pgdmch maternal child health">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Maternal and Child Health</h3>
                <p class="course-code">PGDMCH</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="#" class="course-card" data-search="pgdeoh environmental occupational health">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Environmental and Occupational Health</h3>
                <p class="course-code">PGDEOH</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDFSQM-Admission-2025']) }}" class="course-card" data-search="pgdfsqm food safety quality management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Food Safety and Quality Management</h3>
                <p class="course-code">PGDFSQM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
