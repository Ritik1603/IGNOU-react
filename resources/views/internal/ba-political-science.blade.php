...
@section('page_h1', 'Political Science, IGNOU Solved Assignments')
  ...
  <div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm" style="background-image:url(images/background/bg3.jpg);">
    <div class="container">
      <div class="dz-bnr-inr-entry">
        <h1>Political Science, IGNOU Solved Assignments</h1>
        <nav aria-label="breadcrumb" class="breadcrumb-row">
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('page.show', ['page' => 'index']) }}"> Home</a></li>
            <li class="breadcrumb-item">BA -> Political Science</li>
          </ul>
        </nav>
      </div>
    </div>
  ...
  <div class="product-grid container-fluid mt-5 mb-5">
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 101</h3>
        <p class="product-subtitle">Understanding Political Theory</p>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 102</h3>
        <p class="product-subtitle">Constitutional Government and Democracy in India </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 103 </h3>
        <p class="product-subtitle">Political Theory-Concepts and Debates</p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 104 </h3>
        <p class="product-subtitle">Political Process in India </p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 105 </h3>
        <p class="product-subtitle">Introduction to Comparative Government and Politics</p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
    ...
    <div class="product-card">
      ...
      <div class="product-content">
        <h3 class="product-title">BPSC 107 </h3>
        <p class="product-subtitle">Perspectives on International Relations and World History</p>
        <label>Type</label>
        <select>
          <option>Typed</option>
          <option>Soft Copy</option>
