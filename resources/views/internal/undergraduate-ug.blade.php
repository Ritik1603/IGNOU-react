...
@section('page_h1', 'Undergraduate UG')
...
<style>
    :root {
        ...
        --text: #0f172a;
        --text-light: #64748b;
        --shadow: 0 15px 35px rgba(5, 112, 179, 0.08);
        --shadow-hover: 0 25px 50px rgba(5, 112, 179, 0.22);
        --radius: 24px;
    ...
    * {
    ...
    .page-title {
        ...
        font-size: 2.8rem;
        font-weight: 800;
        background: linear-gradient(120deg, #0570B3, #3b82f6, #10b981);
    ...
    .search-bar:focus {
        ...
        box-shadow: 0 15px 40px rgba(5, 112, 179, 0.2);
    ...
    .layer-1 {
        background: linear-gradient(135deg, rgba(5, 112, 179, 0.12) 0%, rgba(59, 130, 246, 0.08) 100%);
        transform: translateZ(-20px);
        opacity: 0;
    }
    ...
    .layer-3 {
        background: radial-gradient(circle at 30% 30%, rgba(5, 112, 179, 0.15), transparent 60%);
    ...
    .course-card:hover .arrow-3d {
        ...
        box-shadow: 0 15px 30px rgba(5, 112, 179, 0.4);
    }
...
<div class="container">
    <h3 class="page-title">Undergraduate UG</h3>
    <p class="page-subtitle">Choose from 50+ IGNOU UG Programmes with solved material</p>
    ...
    <div id="courseList">
        <!-- ALL 50+ UG PROGRAMMES -->
        <a href="{{ route('page.show', ['page' => 'Undergraduate-Subject']) }}" class="course-card">
