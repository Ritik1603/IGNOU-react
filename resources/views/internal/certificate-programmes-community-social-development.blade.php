...
@section('page_h1', 'Community & Social Development Programmes')
...
<div class="container">
    <h3 class="page-title">Community & Social Development Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCR%20(Certificate%20in%20Community%20Radio)" class="course-card" data-search="ccr community radio">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Community Radio</h3><p class="course-code">CCR</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CSWCJS%20(Certificate%20in%20Social%20Work%20and%20Criminal%20Justice%20System)" class="course-card" data-search="cswcjs social work criminal justice">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Social Work and Criminal Justice System</h3><p class="course-code">CSWCJS</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CRD%20(Certificate%20in%20Rural%20Development)" class="course-card" data-search="crd rural development">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Rural Development</h3><p class="course-code">CRD</p></div>
            <div class="arrow-3d">→</div>
        </a>
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CIS%20(Certificate%20in%20Sericulture)" class="course-card" data-search="cis sericulture">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Sericulture</h3><p class="course-code">CIS</p><div class="note">(also under Agriculture)</div></div>
            <div class="arrow-3d">→</div>
        </a>
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CTRS%20(Certificate%20in%20Tribal%20Studies)" class="course-card" data-search="ctrs tribal studies">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Tribal Studies</h3><p class="course-code">CTRS</p><div class="note">(also under Arts & Culture)</div></div>
            <div class="arrow-3d">→</div>
        </a>
