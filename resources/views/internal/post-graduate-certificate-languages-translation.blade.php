...
@section('page_h1', 'Languages & Translation Programme')
...
<div class="container">
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCBHT%20(Post%20Graduate%20Certificate%20in%20Bangla-Hindi%20Translation)" class="course-card" data-search="pgcbht bangla hindi translation">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Certificate in Bangla-Hindi Translation</h3>
                <p class="course-code">PGCBHT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCMHT%20(Post%20Graduate%20Certificate%20in%20Malayalam-Hindi%20Translation)" class="course-card" data-search="pgcmht malayalam hindi translation">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Certificate in Malayalam-Hindi Translation</h3>
                <p class="course-code">PGCMHT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
