...
@section('page_h1', 'Agriculture, Environment & Animal Husbandry Programmes')
...
<div class="container">
    <h3 class="page-title">Agriculture, Environment & Animal Husbandry Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20COF%20(Certificate%20in%20Organic%20Farming)" class="course-card" data-search="cof organic farming">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Organic Farming</h3><p class="course-code">COF</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CIS%20(Certificate%20in%20Sericulture)" class="course-card" data-search="cis sericulture">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Sericulture</h3><p class="course-code">CIS</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CWHM%20(Certificate%20in%20Water%20Harvesting%20&%20Management)" class="course-card" data-search="cwhm water harvesting">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Water Harvesting & Management</h3><p class="course-code">CWHM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CPF%20(Certificate%20in%20Poultry%20Farming)" class="course-card" data-search="cpf poultry farming">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Poultry Farming</h3><p class="course-code">CPF</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CIB%20(Certificate%20in%20Beekeeping)" class="course-card" data-search="cib beekeeping">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Beekeeping</h3><p class="course-code">CIB</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CES%20(Certificate%20in%20Environmental%20Studies)" class="course-card" data-search="ces environmental studies">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Environmental Studies</h3><p class="course-code">CES</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCE%20(Certificate%20in%20Climate%20Change)" class="course-card" data-search="cce climate change">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Climate Change</h3><p class="course-code">CCE</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CGAS%20(Certificate%20in%20Gender,%20Agriculture%20and%20Sustainable%20Development)" class="course-card" data-search="cgas gender agriculture sustainable">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Gender, Agriculture and Sustainable Development</h3><p class="course-code">CGAS</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20ACE%20(Appreciation%20Course%20on%20Environment)" class="course-card" data-search="ace environment">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Appreciation Course on Environment</h3><p class="course-code">ACE</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CSWM%20(Certificate%20in%20Solid%20Waste%20Management)" class="course-card" data-search="cswm solid waste">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Solid Waste Management</h3><p class="course-code">CSWM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CWWM%20(Certificate%20in%20Waste%20to%20Wealth%20Management)" class="course-card" data-search="cwwm waste to wealth">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Waste to Wealth Management</h3><p class="course-code">CWWM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CSRL%20(Certificate%20in%20Sustainable%20Rural%20Livelihoods)" class="course-card" data-search="csrl sustainable rural">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Sustainable Rural Livelihoods</h3><p class="course-code">CSRL</p></div>
            <div class="arrow-3d">→</div>
        </a>
