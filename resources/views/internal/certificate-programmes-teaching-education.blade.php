...
@section('page_h1', 'Teaching & Education Programmes')
...
<div class="container">
    <h3 class="page-title">Teaching & Education Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CPDT%20(Certificate%20in%20Professional%20Development%20of%20Teachers)" class="course-card" data-search="cpdt professional development teachers">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Professional Development of Teachers</h3><p class="course-code">CPDT</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CTE%20(Certificate%20in%20Teaching%20of%20English%20as%20a%20Second%20Language)" class="course-card" data-search="cte teaching english second language">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Teaching of English as a Second Language</h3><p class="course-code">CTE</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CTPM%20(Certificate%20in%20Teaching%20of%20Primary%20School%20Mathematics)" class="course-card" data-search="ctpm primary school mathematics">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Teaching of Primary School Mathematics</h3><p class="course-code">CTPM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CLTA%20(Certificate%20in%20Life%20and%20Thought%20of%20Dr.%20B.R.%20Ambedkar)" class="course-card" data-search="clta ambedkar life thought">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Life and Thought of Dr. B.R. Ambedkar</h3><p class="course-code">CLTA</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CPNVCR%20(Certificate%20in%20Peace%20and%20Non-Violent%20Conflict%20Resolution)" class="course-card" data-search="cpnvcr peace non-violent conflict">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Peace and Non-Violent Conflict Resolution</h3><p class="course-code">CPNVCR</p></div>
            <div class="arrow-3d">→</div>
        </a>
