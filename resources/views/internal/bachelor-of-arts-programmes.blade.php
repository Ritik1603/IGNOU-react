...
@section('page_h1', 'Bachelor of Arts Programmes')
...
<div class="container">
    <h3 class="page-title">Bachelor of Arts Programmes</h3>
    ...
    <div id="courseList">
        <!-- Only Bachelor of Arts cards -->

        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-History-Admission-2025']) }}" class="course-card">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-Economics-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Political-Science-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Psychology-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Public-Administration-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Journalism-and-Digital-Media-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Micro-Small-and-Medium-Enterprises-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-in-Facility-and-Services-Management-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BA-Admission-2025']) }}" class="course-card">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
