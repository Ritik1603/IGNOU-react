...
@section('page_h1', 'Psychology, IGNOU Solved Assignments')
	...
	<div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm" style="background-image:url(images/background/bg3.jpg);">
		<div class="container">
			<div class="dz-bnr-inr-entry">
				<h1>Psychology, IGNOU Solved Assignments</h1>
				<nav aria-label="breadcrumb" class="breadcrumb-row">
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{ route('page.show', ['page' => 'index']) }}"> Home</a></li>
						<li class="breadcrumb-item">BA -> Psychology</li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div class="product-grid container-fluid mt-5 mb-5">
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 101</h3>
				<p class="product-subtitle">Introduction to Psychology</p>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 104 </h3>
				<p class="product-subtitle">Statistical Methods for Psychological Research-I </p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 105 </h3>
				<p class="product-subtitle">Psychological Research</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 106 </h3>
				<p class="product-subtitle">Development of Psychological Thought </p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 107 </h3>
				<p class="product-subtitle">Social Psychology</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPCC 109</h3>
				<p class="product-subtitle">Development Psychology</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
