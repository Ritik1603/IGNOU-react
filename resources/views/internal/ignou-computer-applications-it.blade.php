...
@section('page_h1', 'Computer Applications & Information Security')
...
<div class="container">
    <h3 class="page-title">Computer Applications & Information Security</h3>
    ...
    <div id="courseList">
        ...
        <!-- 43. MCA_NEW -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MCA-Admission-2025-Master-of-Computer-Applications']) }}" class="course-card" data-search="computer applications mca_new">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Master of Computer Applications</h3>
                <p class="course-code">MCA_NEW</p>
            </div>
        ...
        <!-- 45. MSCMACS -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MSC-Mathematics-Admission-2025']) }}" class="course-card" data-search="mathematics computer science mscmacs">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
