...
@section('page_h1', 'Bachelor Of Science Programmes')
...
<div class="container">
    <h3 class="page-title">Bachelor Of Science Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-BSC-Anthropology-Honours-Admission-2025']) }}" class="course-card">
