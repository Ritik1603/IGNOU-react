...
@section('page_h1', 'Medical & Disaster Management Programmes')
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .course-card {
        background: var(--card-bg); border-radius: var(--radius); padding: 28px 30px; position: relative; height: 160px;
...
<div class="container">
    <h3 class="page-title">Medical & Disaster Management Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCAR%20(Post%20Graduate%20Certificate%20in%20Anuvaad%20evam%20Rupantaran%20mein%20Snatakottar%20Pramanpatra)" class="course-card" data-search="pgcar anuvaad rupantaran translation">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Certificate in Anuvaad evam Rupantaran mein Snatakottar Pramanpatra</h3>
                <p class="course-code">PGCAR</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCMDM%20(Post%20Graduate%20Certificate%20in%20Medical%20Management%20of%20CBRNE%20Disasters)" class="course-card" data-search="pgcmdm cbrne disaster medical management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Certificate in Medical Management of CBRNE Disasters</h3>
                <p class="course-code">PGCMDM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
