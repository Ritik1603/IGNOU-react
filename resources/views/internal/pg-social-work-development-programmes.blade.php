...
@section('page_h1', 'Social Work & Development Programmes')
...
<div class="container">
    <h3 class="page-title">Social Work & Development Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="#" class="course-card" data-search="pgdsw social work">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Social Work</h3>
                <p class="course-code">PGDSW</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDCOUN-Admission-2026-PGD-Social-Work-Counselling']) }}" class="course-card" data-search="pgdswc social work counselling">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Social Work Counselling</h3>
                <p class="course-code">PGDSWC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDDVS-Admission-2025']) }}" class="course-card" data-search="pgddvs development studies">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Development Studies</h3>
                <p class="course-code">PGDDVS</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDUPDL-Admission-2025']) }}" class="course-card" data-search="pgdupdl urban planning development">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Urban Planning and Development</h3>
                <p class="course-code">PGDUPDL</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDCSR-Admission-2025']) }}" class="course-card" data-search="pgdcsr corporate social responsibility">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Corporate Social Responsibility</h3>
                <p class="course-code">PGDCSR</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Sustainability-Science-Admission']) }}" class="course-card" data-search="pgdss sustainability science">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Sustainability Science</h3>
                <p class="course-code">PGDSS</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
