...
@section('page_h1', 'Administration & Development Programmes')
...
<div class="container">
    <h3 class="page-title">Administration & Development Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DPLAD%20(Diploma%20in%20Panchayat%20Level%20Administration%20and%20Development)" class="course-card" data-search="9.3 dplad panchayat administration development">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Panchayat Level Administration and Development</h3>
                <p class="course-code">DPLAD </p>
            </div>
