				...
				<div class="col-lg-6">
					<div class="widget">
						<form class="shop-form">
							...
							<div class="form-group">
								<a href="{{ route('page.show', ['page' => 'shop-cart']) }}" class="btn btn-primary btnhover" type="button">Apply Coupon</a>
							</div>
						</form>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="widget">
						...
						<div class="form-group m-b25">
							<a href="{{ route('page.show', ['page' => 'shop-checkout']) }}" class="btn btn-primary btnhover" type="button">Proceed to Checkout</a>
						</div>
					</div>
				</div>
			</div>
