...
@section('page_h1', 'Public Administration, IGNOU Solved Assignments')
	...
	<div class="dz-bnr-inr overlay-secondary-dark dz-bnr-inr-sm" style="background-image:url(images/background/bg3.jpg);">
		<div class="container">
			<div class="dz-bnr-inr-entry">
				<h1>Public Administration, IGNOU Solved Assignments</h1>
				<nav aria-label="breadcrumb" class="breadcrumb-row">
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{ route('page.show', ['page' => 'index']) }}"> Home</a></li>
						<li class="breadcrumb-item">BA -> Public Administration</li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div class="product-grid container-fluid mt-5 mb-5">
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 101</h3>
				<p class="product-subtitle">Perspectives on Public Administration</p>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 102</h3>
				<p class="product-subtitle">Administrative Thinkers</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 103 </h3>
				<p class="product-subtitle">Administrative System at Union Level </p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 104</h3>
				<p class="product-subtitle">Administrative System at State and District Levels </p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 105 </h3>
				<p class="product-subtitle">Personnel Administration</p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
		...
		<div class="product-card">
			...
			<div class="product-content">
				<h3 class="product-title">BPAC 106 </h3>
				<p class="product-subtitle">Understanding Public Policy </p>
				<label>Type</label>
				<select>
					<option>Typed</option>
					<option>Soft Copy</option>
