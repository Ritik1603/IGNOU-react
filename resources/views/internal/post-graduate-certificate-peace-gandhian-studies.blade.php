...
@section('page_h1', 'Peace & Gandhian Studies Programmes')
...
<div class="container">
    <h3 class="page-title">Peace & Gandhian Studies Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCGPS%20(Post%20Graduate%20Certificate%20in%20Gandhi%20and%20Peace%20Studies)" class="course-card" data-search="10.9 pgcgps gandhi peace studies">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Certificate in Gandhi and Peace Studies</h3>
                <p class="course-code">PGCGPS </p>
            </div>
