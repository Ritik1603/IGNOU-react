...
@section('page_h1', 'Healthcare & Nursing Programmes')
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .course-card:hover .layer-3 { opacity: 1; }
...
<div class="container">
    <h3 class="page-title">Healthcare & Nursing Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'Diploma-in-Early-Childhood-Care-and-Education']) }}" class="course-card" data-search="9.1 dece early childhood care education">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Early Childhood Care and Education</h3>
                <p class="course-code">DECE </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'Diploma-in-Nutrition-Health-Education']) }}" class="course-card" data-search="9.2 dnhe nutrition health education">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Nutrition & Health Education</h3>
                <p class="course-code">DNHE </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DCCN%20(Diploma%20in%20Critical%20Care%20Nursing)" class="course-card" data-search="9.24 dccn critical care nursing">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Critical Care Nursing</h3>
                <p class="course-code">DCCN </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DTH%20(Diploma%20in%20Theatre%20Arts)" class="course-card" data-search="9.25 dth theatre arts healthcare">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Theatre Arts<br><small style="font-weight:500;color:#64748b;">(Applicable in healthcare settings)</small></h3>
