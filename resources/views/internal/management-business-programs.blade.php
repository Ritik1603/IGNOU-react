...
@section('page_h1', 'MBA & M.Com Programmes')
...
<div class="container">
    <h3 class="page-title">MBA & M.Com Programmes</h3>
    ...
    <div id="courseList">
        ...
        <!-- 1. MCOM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MCom-Admission-2025']) }}" class="course-card" data-search="mcom master of commerce">
        ...
        <!-- 2. MBA -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-Admission-2025']) }}" class="course-card" data-search="mba master of business administration">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 3. MBF -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Banking-and-Finance-Admission-2025']) }}" class="course-card" data-search="mbf banking finance">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 4. MBAHM (HR) -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Human-Resource-Management-Admission-2025']) }}" class="course-card" data-search="mbahm human resource hr">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 5. MBAFM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-Master-of-Business-Administration-Financial-Management']) }}" class="course-card" data-search="mbafm finance financial management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 6. MBAOM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Operations-Management-Admission-2025']) }}" class="course-card" data-search="mbaom operations management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 7. MBAMM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Marketing-Management-Admission-2025']) }}" class="course-card" data-search="mbamm marketing management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 8. MBALSCM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Logistics-Supply-Chain-Management-Admission-2025']) }}" class="course-card" data-search="mbalsm logistics supply chain">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 9. MBACM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Construction-Management-Admission-2025']) }}" class="course-card" data-search="mbacm construction management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 10. MBAHA (Hospital Admin) -->
        <a href="#" class="course-card" data-search="mbaha hospital administration">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 11. MBATQM -->
        <a href="#" class="course-card" data-search="mbatqm total quality management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 12. MBAHHM -->
        <a href="{{ route('page.show', ['page' => 'IGNOU-MBA-in-Healthcare-and-Hospital-Management-Admission-2025']) }}" class="course-card" data-search="mbahhm hospital healthcare management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
        ...
        <!-- 13. MBAER -->
        <a href="#" class="course-card" data-search="mbaer entrepreneurship">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
