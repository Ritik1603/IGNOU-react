...
@section('page_h1', 'Environment & Disaster Management Programmes')
...
<style>
    ...
    * {
    ...
    .search-bar {
        ...
        outline: none;
           box-shadow: 0 8px 25px rgb(199 193 193);
...
<div class="container">
    <h3 class="page-title">Environment & Disaster Management Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDESD-Admission-2025']) }}" class="course-card" data-search="pgdesd environment sustainable development">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Environment and Sustainable Development</h3>
                <p class="course-code">PGDESD</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDAC-Admission-2025']) }}" class="course-card" data-search="pgdac analytical chemistry">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Analytical Chemistry</h3>
                <p class="course-code">PGDAC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDDRM-Admission-2025']) }}" class="course-card" data-search="pgdrrm disaster risk reduction management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Disaster Risk Reduction and Management</h3>
                <p class="course-code">PGDDRM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDAW-Admission-2025']) }}" class="course-card" data-search="pgdaw animal welfare">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Animal Welfare</h3>
                <p class="course-code">PGDAW</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
