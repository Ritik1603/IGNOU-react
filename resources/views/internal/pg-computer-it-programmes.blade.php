...
@section('page_h1', 'Computer & IT Programmes')
...
<style>
    ...
    * {
    ...
    .search-bar {
        ...
        outline: none;
        box-shadow: 0 8px 25px rgba(0, 0, .1);
...
<div class="container">
    <h3 class="page-title">Computer & IT Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Computer-Applications']) }}" class="course-card" data-search="pgdca_new computer applications">
            ...
            <div class="course-info">
                ...
                <p class="course-code">PGDCA_NEW</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDIS-Admission-2025']) }}" class="course-card" data-search="pgdis information security cyber">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Information Security</h3>
                <p class="course-code">PGDIS</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
