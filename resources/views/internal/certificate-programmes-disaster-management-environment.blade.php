...
@section('page_h1', 'Disaster Management & Environment Programmes')
...
<style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .course-card{background:var(--card-bg);border-radius:var(--radius);padding:28px 30px;position:relative;height:160px;
    ...
    @media(max-width:768px){#courseList{grid-template-columns:1fr;}.page-title{font-size:2rem;}.course-card{height:180px;}}
</style>

<div class="container">
    <h3 class="page-title">Disaster Management & Environment Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CDM%20(Certificate%20in%20Disaster%20Management)" class="course-card" data-search="cdm disaster management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Disaster Management</h3><p class="course-code">CDM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CSWATT%20(Certificate%20in%20Solid%20Waste%20Treatment%20Techniques)" class="course-card" data-search="cswatt solid waste treatment">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Solid Waste Treatment Techniques</h3><p class="course-code">CSWATT</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20PGCMDM%20(Certificate%20in%20Medical%20Management%20of%20CBRNE%20Disasters)" class="course-card" data-search="pgcmdm cbrne disaster">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Medical Management of CBRNE Disasters</h3><p class="course-code">PGCMDM</p><div class="note">(Post Graduate Certificate)</div></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CHCWM%20(Certificate%20in%20Health%20Care%20Waste%20Management)" class="course-card" data-search="chcwm health care waste">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Health Care Waste Management</h3><p class="course-code">CHCWM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CSCDM%20(Certificate%20in%20Smart%20City%20Development%20and%20Management)" class="course-card" data-search="cscdm smart city">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Smart City Development and Management</h3><p class="course-code">CSCDM</p></div>
            <div class="arrow-3d">→</div>
        </a>
