...
@section('page_h1', 'Business, Skills & Laboratory Programmes')
...
<div class="container">
    <h3 class="page-title">Business, Skills & Laboratory Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CBS%20(Certificate%20in%20Business%20Skills)" class="course-card" data-search="cbs business skills">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Business Skills</h3><p class="course-code">CBS</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CAPMER%20(Certificate%20in%20Apparel%20Merchandising)" class="course-card" data-search="capmer apparel merchandising">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Apparel Merchandising</h3><p class="course-code">CAPMER</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CPLT%20(Certificate%20in%20Laboratory%20Techniques)" class="course-card" data-search="cplt laboratory techniques">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Laboratory Techniques</h3><p class="course-code">CPLT</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CFDE%20(Certificate%20in%20Fashion%20Design)" class="course-card" data-search="cfde fashion design">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Fashion Design</h3><p class="course-code">CFDE</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CPY%20(Certificate%20in%20Programme%20in%20Yoga)" class="course-card" data-search="cpy yoga">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Programme in Yoga</h3><p class="course-code">CPY</p></div>
            <div class="arrow-3d">→</div>
        </a>
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCS%20(Certificate%20in%20Communication%20Skills)" class="course-card" data-search="ccs communication skills">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Communication Skills</h3><p class="course-code">CCS</p></div>
            <div class="arrow-3d">→</div>
        </a>
