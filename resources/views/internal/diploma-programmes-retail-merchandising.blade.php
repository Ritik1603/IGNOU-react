...
@section('page_h1', 'Retail & Merchandising Programmes')
...
<div class="container">
    <h3 class="page-title">Retail & Merchandising Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DAPMER%20(Diploma%20in%20Apparel%20Merchandising)" class="course-card" data-search="9.5 dapmer apparel merchandising">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Apparel Merchandising</h3>
                <p class="course-code">DAPMER • 9.5</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DFDR%20(Diploma%20in%20Fashion%20Design%20and%20Retail)" class="course-card" data-search="9.18 dfdr fashion design retail">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Fashion Design and Retail</h3>
                <p class="course-code">DFDR • 9.18</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DIRL%20(Diploma%20in%20Retailing)" class="course-card" data-search="9.21 dirl retailing">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Retailing</h3>
                <p class="course-code">DIRL • 9.21</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
