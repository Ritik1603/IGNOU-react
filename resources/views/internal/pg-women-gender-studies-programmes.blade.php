...
@section('page_h1', 'Women & Gender Studies Programmes')
...
<div class="container">
    <h3 class="page-title">Women & Gender Studies Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'Post-Graduate-Diploma-in-Womens-Gender-Studies']) }}" class="course-card" data-search="pgdwgsr women gender studies">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Women’s & Gender Studies</h3>
                <p class="course-code">PGDWGSR</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="#" class="course-card" data-search="pgdbp book publishing">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Book Publishing</h3>
                <p class="course-code">PGDBP</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
