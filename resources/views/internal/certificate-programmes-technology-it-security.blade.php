...
@section('page_h1', 'Technology, IT & Security Programmes')
...
<div class="container">
    <h3 class="page-title">Technology, IT & Security Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CIT%20(Certificate%20in%20Information%20Technology)" class="course-card" data-search="cit information technology">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Information Technology</h3><p class="course-code">CIT</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CMAD%20(Certificate%20in%20Mobile%20Application%20Development)" class="course-card" data-search="cmad mobile app development">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Mobile Application Development</h3><p class="course-code">CMAD</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCITSK%20(Certificate%20in%20Communication%20&%20IT%20Skills)" class="course-card" data-search="ccitsk communication it skills">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Communication & IT Skills</h3><p class="course-code">CCITSK</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20ACISE%20(Advanced%20Certificate%20in%20Information%20Security)" class="course-card" data-search="acise information security">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Advanced Certificate in Information Security</h3><p class="course-code">ACISE</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCOMO%20(Certificate%20in%20Condition%20Monitoring)" class="course-card" data-search="ccomo condition monitoring">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Condition Monitoring</h3><p class="course-code">CCOMO</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CETM%20(Certificate%20in%20Energy%20Technology%20and%20Management)" class="course-card" data-search="cetm energy technology">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Energy Technology and Management</h3><p class="course-code">CETM</p></div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20CCPD%20(Certificate%20in%20Competency%20in%20Power%20Distribution)" class="course-card" data-search="ccpd power distribution">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info"><h3>Certificate in Competency in Power Distribution</h3><p class="course-code">CCPD</p></div>
            <div class="arrow-3d">→</div>
        </a>
