...
@section('page_h1', 'Management & Business Programmes')
...
<div class="container">
    <h3 class="page-title">Management & Business Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDIBO-Admission-2025']) }}" class="course-card" data-search="pgdibo international business operations">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in International Business Operations</h3>
                <p class="course-code">PGDIBO</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="#" class="course-card" data-search="pgdiom operations management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Operations Management</h3>
                <p class="course-code">PGDIOM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Marketing-Management']) }}" class="course-card" data-search="pgdimm marketing management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Marketing Management</h3>
                <p class="course-code">PGDIMM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Financial-Management']) }}" class="course-card" data-search="pgdifm financial management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Financial Management</h3>
                <p class="course-code">PGDIFM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Human-Resource-Management']) }}" class="course-card" data-search="pgdihrm human resource management">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Human Resource Management</h3>
                <p class="course-code">PGDIHRM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-Post-Graduate-Diploma-in-Financial-Markets-Practice']) }}" class="course-card" data-search="pgdfmp financial markets practice">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Financial Markets Practice</h3>
                <p class="course-code">PGDFMP</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
