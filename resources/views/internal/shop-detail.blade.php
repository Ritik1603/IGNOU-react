                            ...
                            <div class="dz-body">
                                ...
                                <div class="book-footer">
                                    ...
                                    <div class="product-num">
                                        ...
                                        <a href="{{ route('page.show', ['page' => 'shop-checkout']) }}" class="btn btn-primary btnhover btnhover2"> <span>Checkout</span></a>
    ...
    <div class="bg-white py-5">
        <div class="container">
            ...
            <div class="swiper client-swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                <div class="swiper-wrapper" id="swiper-wrapper-d5dd32763872848d" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-292.5px, 0px, 0px); transition-delay: 0ms;">
                    <div class="swiper-slide swiper-slide-prev" style="width: 292.5px;" role="group" aria-label="1 / 5"><img src="images/client/client1.svg" alt="client"></div>
                    <div class="swiper-slide swiper-slide-active" style="width: 292.5px;" role="group" aria-label="2 / 5"><img src="images/client/client2.svg" alt="client"></div>
                    <div class="swiper-slide swiper-slide-next" style="width: 292.5px;" role="group" aria-label="3 / 5"><img src="images/client/client3.svg" alt="client"></div>
                    <div class="swiper-slide" style="width: 292.5px;" role="group" aria-label="4 / 5"><img src="images/client/client4.svg" alt="client"></div>
