...
@section('page_h1', 'Journalism & Communication Programmes')
...
<style>
    ...
    * {
    ...
    .search-bar {
        ...
        outline: none;
        box-shadow: 0 8px 25px rgb(217 211 211);
...
<div class="container">
    <h3 class="page-title">Journalism & Communication Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="{{ route('page.show', ['page' => 'IGNOU-PGJMC-Admission-2025']) }}" class="course-card" data-search="pgjmc journalism mass communication">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Journalism and Mass Communication</h3>
                <p class="course-code">PGJMC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDAPP-Admission-2025']) }}" class="course-card" data-search="pgdapp audio programme production">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Audio Programme Production</h3>
                <p class="course-code">PGDAPP</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDIDM-Admission-2025']) }}" class="course-card" data-search="pgdidm digital media">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Digital Media</h3>
                <p class="course-code">PGDIDM</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDDC-Admission-2025']) }}" class="course-card" data-search="pgddc development communication">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Development Communication</h3>
                <p class="course-code">PGDDC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="{{ route('page.show', ['page' => 'IGNOU-PGDAIC-Admission-2025']) }}" class="course-card" data-search="pgdaic advertising integrated communication">
            <div class="card-layer layer-1"></div>
            <div class="card-layer layer-2"></div>
            <div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Post Graduate Diploma in Advertising and Integrated Communication</h3>
                <p class="course-code">PGDAIC</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
