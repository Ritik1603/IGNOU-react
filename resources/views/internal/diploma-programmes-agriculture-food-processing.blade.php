...
@section('page_h1', 'Agriculture & Food Processing Programmes')
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .search-bar {
        ...
        outline: none;
        box-shadow: 0 8px 25px rgb(213 213 213);
    ...
    .arrow-3d {
        ...
        font-size: 1.5rem; font-weight: 900; transition: var(--transition);
        box-shadow: 0 8px 20px rgba(59, 130, 246, .3); transform: translateZ(45px);
    }
    ...
    .course-card:nth-child(n) { animation-delay: calc(0.1s * var(--n, 1)); }

    @media (max-width: 768px) {
        #courseList { grid-template-columns: 1fr; }
        .page-title { font-size: 2rem; }
        .course-card { height: 130px; }
    }
</style>

<div class="container">
    <h3 class="page-title">Agriculture & Food Processing Programmes</h3>
    ...
    <div id="courseList">
        ...
        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DVAPFV%20(Diploma%20in%20Value%20Added%20Products%20from%20Fruits%20&%20Vegetables)" class="course-card" data-search="9.8 dvapfv value added fruits vegetables">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Value Added Products from Fruits & Vegetables</h3>
                <p class="course-code">DVAPFV</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DDT%20(Diploma%20in%20Dairy%20Technology)" class="course-card" data-search="9.9 ddt dairy technology">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Dairy Technology</h3>
                <p class="course-code">DDT </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DMT%20(Diploma%20in%20Meat%20Technology)" class="course-card" data-search="9.10 dmt meat technology">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Meat Technology</h3>
                <p class="course-code">DMT </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DWM%20(Diploma%20in%20Watershed%20Management)" class="course-card" data-search="9.11 dwm watershed management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Watershed Management</h3>
                <p class="course-code">DWM </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DHORT%20(Diploma%20in%20Horticulture)" class="course-card" data-search="9.12 dhort horticulture">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Horticulture</h3>
                <p class="course-code">DHORT</p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DACM%20(Diploma%20in%20Agricultural%20Cost%20Management)" class="course-card" data-search="9.13 dacm agricultural cost management">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Agricultural Cost Management</h3>
                <p class="course-code">DACM </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>

        <a href="https://wa.me/919355198199?text=Hi!%20I%20want%20to%20know%20more%20about%20DAQ%20(Diploma%20in%20Aquaculture)" class="course-card" data-search="9.20 daq aquaculture">
            <div class="card-layer layer-1"></div><div class="card-layer layer-2"></div><div class="card-layer layer-3"></div>
            <div class="course-info">
                <h3>Diploma in Aquaculture</h3>
                <p class="course-code">DAQ </p>
            </div>
            <div class="arrow-3d">→</div>
        </a>
